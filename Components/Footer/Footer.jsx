  ...
  return (
    <footer className=" py-8 ">
      ...
      <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/6  mb-8 relative">
          ...
          <h1 className='-rotate-90 absolute text-MainColor text-5xl top-10 -left-10'>DIRISE</h1>
        </div>
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 px-4 mb-8">
          ...
          <ul className='flex flex-col gap-5'>
            <li>
              <Link href="/services">
                <h1 className="text-gray-600 hover:text-gray-800">About Dirise</h1>
              </Link>
            </li>
            <li>
              <Link href="/blog">
                <h1 className="text-gray-600 hover:text-gray-800">Environment</h1>
              </Link>
            </li>
          </ul>
        </div>
      ...
      <footer className="py-4 pb-10 text-center">
